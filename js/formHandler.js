		    		...
		    		success: function() // Success
		 			{  
			   		...
			   		error: function() // Fail
			   		{
						...
						{
							$form.append("<div id='form-alert'><div class='alert alert-danger'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button><strong>"+"Notre serveur de messagerie ne répond pas. Désolé pour le désagrément!"+"</strong></div></div>");
						}	
			   		},
		   		});
			}
